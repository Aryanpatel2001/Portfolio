...
//     description: "A full-featured LMS platform enabling seamless course management and user engagement.",
//     features: [
...
//     description: "An AI-powered presentation builder enabling users to create stunning presentations effortlessly.",
//     features: [
...
//     ],
//     technologies: ["AI", "TypeScript", "Node.js", "Next.js", "LemonSqueezy", "Vercel"],
//     githubUrl: "https://github.com/Aryanpatel2001",
//     liveUrl: "#",
//   },
// ]
...
//             <Card
//               key={index}
//               className="border-none shadow-md hover:shadow-lg transition-shadow overflow-hidden hover-lift"
//             >
//               <CardHeader className="pb-2">
//                 <CardTitle className="text-xl purple-teal-text-gradient">{project.title}</CardTitle>
//                 <CardDescription>{project.description}</CardDescription>
//               </CardHeader>
//               <CardContent className="pb-2">
//                 <h4 className="font-medium mb-2">Key Features:</h4>
//                 <ul className="space-y-1 mb-4 text-sm text-foreground/80">
...
//                 <Button asChild variant="outline" size="sm" className="border-primary/20 hover:border-primary">
//                   <Link href={project.githubUrl} target="_blank" rel="noopener noreferrer">
//                     <Github className="mr-2 h-4 w-4" />
//                     Code
//                   </Link>
//                 </Button>
//                 <Button asChild size="sm" className="purple-teal-gradient hover:opacity-90 transition-opacity">
