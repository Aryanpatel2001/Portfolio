...
//           <div>
//             <h3 className="text-2xl font-semibold mb-4 flex items-center purple-teal-text-gradient">
//               <User className="mr-2 h-5 w-5 text-primary" />
//               Introduction
//             </h3>
//             <p className="text-foreground/80 mb-6">
//               I'm in my 3rd year (6th semester) of B.Tech in Information Technology with a top academic record of 8.99
//               CGPA. I love building websites and apps from front to back.
//             </p>
//             <p className="text-foreground/80 mb-6">
//               I'm looking for an internship opportunity where I can apply my full stack development skills, learn from
//               industry professionals, and gain valuable work experience before graduating.
//             </p>
...
//               Education
//             </h3>
//             <Card className="border-none shadow-md hover:shadow-lg transition-shadow hover-lift overflow-hidden">
//               <CardContent className="p-6 relative shimmer">
//                 <h4 className="text-xl font-medium mb-2">B.Tech in Information Technology</h4>
//                 <p className="text-foreground/70 mb-1">Gandhinagar University, Ahmedabad, Gujarat</p>
//                 <p className="text-foreground/70 mb-2">Expected Graduation: 2026</p>
//                 <p className="purple-teal-text-gradient font-medium">CGPA: 8.99</p>
//               </CardContent>
//             </Card>
//           </div>
//         </div>
